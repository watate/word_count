...
void main() {
  ...
  group('Basic', () {
    ...
    test('Thai', () {
      const content = "บริการฟรีของ Google แปลคำ วลี และหน้าเว็บระหว่างภาษาอังกฤษและภาษาอื่น ๆ กว่า 100 ภาษาได้ทันที";
  ...
  group('Config', () {
    test('Punctuation Breaker', () {
      const content = "Google's free service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(punctuationAsBreaker: true)), equals(18));
    });
    
    test('Wipe out default punctuation list', () {
      const content = "Google's free service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(disableDefaultPunctuation: true)), equals(18));
    });
    
    test('Considering more symbol as punctuation', () {
      const content = "Google's free-service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(punctuation: ['-'])), equals(16));
    });
    
    test('Considering more symbol as punctuation as word breaker', () {
      const content = "Google's free-service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(punctuation: ['-'], punctuationAsBreaker: true)), equals(18));
    });
    ...
    test('Considering more symbol as punctuation as word breaker 2', () {
      const content = "Googles free-service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(punctuation: ['-'], punctuationAsBreaker: true)), equals(17));
    });
    
    test('Only use symbol provided as punctuation', () {
      const content = "Google's free-service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(punctuation: ['-'], disableDefaultPunctuation: true)), equals(17));
    });
    
    test('Only use symbol provided as punctuation 2', () {
      const content = "Googles free-service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(punctuation: ['-'], disableDefaultPunctuation: true)), equals(16));
    });
    
    test('Only use symbol provided as punctuation as word breaker', () {
      const content = "Google's free-service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(punctuation: ['-'], disableDefaultPunctuation: true, punctuationAsBreaker: true)), equals(18));
    });
    
    test('Only use symbol provided as punctuation as word breaker 2', () {
      const content = "Googles free-service instantly translates words, phrases, and web pages between English and over 100 other languages.";
      expect(wordsCount(content, const WordCountConfig(punctuation: ['-'], disableDefaultPunctuation: true, punctuationAsBreaker: true)), equals(17));
    });
  });
  ...
  group('Special', () {
    ...
    test('Same punctuation multiple times as breaker: apostrophe', () {
      const content = "Google's'home is a server.";
      expect(wordsCount(content, const WordCountConfig(punctuationAsBreaker: true)), equals(6));
    });
  ...
  group('Split and detector', () {
    test('English', () {
      ...
      expect(wordsCount(content), equals(17));
      expect(wordsAreExpected(wordsSplit(content), splittedContent), equals(true));
